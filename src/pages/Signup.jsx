                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative z-10 bg-[#0a0a0a]">
                    ...
                    <form onSubmit={handleSignup} className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-3 my-1 opacity-70">
                            ...
                            <span className="text-gray-500 text-xs uppercase tracking-widest font-semibold">Or sign up with</span>
                            <hr className="flex-1 border-gray-800" />
                        </div>
                        ...
                        <div className="flex gap-4">
                            <button 
                                ...
                                className="flex-1 flex items-center justify-center gap-2 bg-black border border-gray-800 p-3 rounded-xl hover:bg-white/5 transition-all shadow-sm group"
                            >
                                ...
                                <span className="text-white text-sm font-bold group-hover:text-gray-200">Google</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="text-white text-sm font-bold group-hover:text-gray-200">LinkedIn</span>
                            </button>
                        </div>

                        <button 
                            type="submit"
                            className="mt-2 bg-purple-600 hover:bg-purple-500 text-white font-bold py-4 rounded-xl shadow-[0_0_20px_rgba(124,58,237,0.4)] transition-all transform hover:scale-[1.01] active:scale-95"
                        >
                            Sign Up
                        </button>
                    </form>
